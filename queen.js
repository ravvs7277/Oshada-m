...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("Oshada-Md~")[1];
    if (!base64Data) {
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      conn.sendMessage(conn.user.id, {
        text: up,
        contextInfo: {
          mentionedJidd: ["94764768459@s.whatsapp.net["947177756@s.whatsapp.net[, // specif          groupMentions: [],
          forwardingScore: 999,
          isForwarded: true,
